...
// ------------------------------------------------------------
// REFRESH TOKEN – Only one request at a time
// ------------------------------------------------------------
...
export const refreshToken = (refreshTokenValue) =>
  api.post('/auth/refresh-token', { refreshToken: refreshTokenValue });
export const logout = () => api.post('/auth/logout');

// ============================================================
// SKILLS
// ============================================================
export const addTeachSkill = (data) => api.post('/skills/teach', data);
export const getTeachSkills = () => api.get('/skills/teach');
export const updateTeachSkill = (id, data) => api.put(`/skills/teach/${id}`, data);
export const deleteTeachSkill = (id) => api.delete(`/skills/teach/${id}`);

export const addLearnSkill = (data) => api.post('/skills/learn', data);
export const getLearnSkills = () => api.get('/skills/learn');
export const updateLearnSkill = (id, data) => api.put(`/skills/learn/${id}`, data);
export const deleteLearnSkill = (id) => api.delete(`/skills/learn/${id}`);

export const getMarketplaceSkills = (params) => api.get('/skills/marketplace', { params });
...
// MATCHES
// ============================================================
export const getRecommendations = () => api.get('/matches/recommendations');
...
export const getMeetingDetails = (id) => api.get(`/sessions/${id}/meeting`);
...
export const getSwapActivity = (period = 'week') =>
  api.get('/analytics/swaps', { params: { period } });
export const getLearningHours = () => api.get('/analytics/hours');

// ============================================================
// LEADERBOARD
// ============================================================
export const getLeaderboard = (type = 'mentors', period = 'alltime', limit = 10) =>
  api.get('/leaderboard', { params: { type, period, limit } });
...
export const adminGetSkills = (page = 1, search = '') =>
  api.get('/admin/skills', { params: { page, limit: 10, search } });
export const adminDeleteSkill = (id) => api.delete(`/admin/skills/${id}`);
export const adminGetSwaps = (page = 1, status = '') =>
  api.get('/admin/swaps', { params: { page, limit: 10, status } });
export const adminUpdateSwap = (id, status) => api.put(`/admin/swaps/${id}`, { status });
...
// SEARCH
// ============================================================
export const globalSearch = (q, type = 'all', limit = 10) =>
  api.get('/search', { params: { q, type, limit } });
export const getTrendingSkills = () => api.get('/search/trending');

// ============================================================
// PUBLIC PROFILE
// ============================================================
export const getPublicProfile = (username) => api.get(`/user/profile/${username}`);
...
// ============================================================
// RESOURCES – CORRECTED (no duplicate exports)
// ============================================================
...
export const getFolders = () => api.get('/resources/folders');
export const createFolder = (data) => api.post('/resources/folders', data);
export const deleteFolder = (id) => api.delete(`/resources/folders/${id}`);
...
export const getQuizResults = (quizId, attemptId) =>
  api.get(`/quizzes/${quizId}/results/${attemptId}`);
export const getQuizLeaderboard = (id) => api.get(`/quizzes/${id}/leaderboard`);

export const getProgressOverview = () => api.get('/progress/overview');
export const getSkillProgress = () => api.get('/progress/skills');
export const getWeeklyActivity = () => api.get('/progress/weekly-activity');
...
export const toggleLikePost = (id) => api.post(`/community/posts/${id}/like`);
...
export const toggleLikeComment = (id) => api.post(`/community/comments/${id}/like`);
